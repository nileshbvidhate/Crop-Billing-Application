...
public class Crop {
	...
	// Constructor
	public Crop(int cropId, int customerId, String cropName, int firstQualityBags, int secondQualityBags,
			int thirdQualityBags, int fourthQualityBags, int fifthQualityBags) {
		this.cropId = cropId;
